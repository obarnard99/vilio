...
RUN pip3 install torch==1.7.0+cu92 torchvision==0.8.1+cu92 torchaudio==0.7.0 -f https://download.pytorch.org/whl/torch_stable.html
RUN pip3 install loguru matplotlib pillow fire
COPY . /FairFace
WORKDIR /FairFace